...
The following table provides the sizes of cryptographic artifacts associated with instantiations of ML-DSA, SLH-DSA, and ML-KEM, aiming for "Level 1 security", as defined in {{NISTSecurityLevels}}, and for HSS/LMS and XMSS instantiations aiming for 192 bits of security ("Level 3 security").
